...
def create_app(test_config=None):
  ...
  def create_questions():
    ...
    try:
      question = Question(new_question, new_answer, new_category, new_diffucilty)
      question.insert()
  ...
  def search_questions():
    ...
    questions = Question.query.filter(Question.question.like(f'%{term}%'))
  ...
  **func.random() was taken from https://stackoverflow.com/questions/60805/getting-random-row-through-sqlalchemy
  '''
  ...
  def quizzes():
    ...
    if cate_id !=0:
      ...
      if len(previous_questions) != 0:
        next_question = next_question.filter(~Question.id.in_(previous_questions))
